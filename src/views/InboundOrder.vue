<template>
  <div>
    ...
    <!-- 详情弹窗 -->
    <el-dialog v-model="detailVisible" title="入库详情" width="500px">
...
const loadData = async () => {
    orders.value = await inventoryApi.getOrders('inbound')
...
const submitOrder = async () => {
    ...
    try {
        const orderData = {
            ...
            type: 'inbound',
            items: JSON.parse(JSON.stringify(form.items)), // deep copy
        ...
        // 记录日志
        logApi.addLog('入库', `入库单 ${form.order_no}`)
